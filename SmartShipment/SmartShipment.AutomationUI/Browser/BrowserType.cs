...
namespace SmartShipment.AutomationUI.Browser
{
    public class BrowserType : IBrowserType
    {
        ...
        public static IBrowserTypeAttributes IeAttributes = new BrowserTypeAttributes(IE_PROCESS_NAME, IE_SEARCH_PATTERN, IE_BROWSER_NAME, IE_CLASS_NAME);
        public static IBrowserTypeAttributes CromeAttributes = new BrowserTypeAttributes(CR_PROCESS_NAME, CR_SEARCH_PATTERN, CR_BROWSER_NAME, CR_CLASS_NAME);
        public static IBrowserTypeAttributes FireFoxAttributes = new BrowserTypeAttributes(FF_PROCESS_NAME, FF_SEARCH_PATTERN, FF_BROWSER_NAME, FF_CLASS_NAME);
